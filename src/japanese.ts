export const text: text = {
  ...
  country: `国`,
  createANewAccountFailed: `新しいアカウントを作成失敗でした`,
  ...
  selectCharacters: `キャラクターを選ぶ`,
  selectFile: `ファイルを選ぶ`,
  selectThumbnail: `サムネイルを選ぶ`,
  sendEmail: `メールを送る`,
  settings: `セット`,
  shareYourStory: `物語を共有して！`,
  shop: `ショップ`,
  signIn: `ログイン`,
  skip: `スキップ`,
  ...
  verifyCode: `コードを確認する`,
  visitOurDiscordChannelToGetMoreDetails: `(en) Visit our discord channel to get more details`,
  ...
  yes: `はい`,
  youAreAlreadyAuthenticated: `もう認証されています`,
